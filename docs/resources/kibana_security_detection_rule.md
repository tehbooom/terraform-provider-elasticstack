...
- `params` (String) JSON-encoded object containing the allowed connector fields, which varies according to the connector type. Use `jsonencode({...})` to set this value.
